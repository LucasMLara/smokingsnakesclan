          ...
          <div ref={contentRef} className="space-y-8">
            ...
            <div className="glass-card p-8 space-y-6">
              <div className="flex items-start gap-4">
                <Map className="w-6 h-6 text-blood-red flex-shrink-0 mt-1" />
                <div>
                  <h2 className="text-2xl font-cinzel font-bold text-foreground mb-3">
                    {t('guides.pve.contextTitle')}
                  </h2>
                  <p className="text-muted-foreground leading-relaxed">
                    {t('guides.pve.context')}
                  </p>
                </div>
              </div>

              <div className="flex items-start gap-4">
                <BookOpen className="w-6 h-6 text-blood-red flex-shrink-0 mt-1" />
                <div>
                  <h3 className="text-xl font-cinzel font-bold text-foreground mb-3">
                    {t('guides.pve.strategyTitle')}
                  </h3>
                  <p className="text-muted-foreground leading-relaxed">
                    {t('guides.pve.strategy')}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="text-center pt-8">
              ...
              >
                ...
                {t('guides.pve.accessGuide')}
              </Button>
              <p className="text-sm text-muted-foreground mt-4">
                {t('guides.pve.guideNote')}
              </p>
            </div>
          </div>
        </div>
